        ...
        <div class="article">
            <div class="article-md-8">
                ...
                <div class='btn-box-view'>
                    <a href='./PHP/delete_account_pc.php' class='btn-delete-profile btn-v1 btn-primary-reset'>
                        Delete Account
                    </a>
                </div>
                <article class="article-blog-post">
                    ...
                    echo "
                    <h4 class='h4-profile'>ID - {$row['user_id']}</h4>
                    <h4 class='h4-profile'>E-Mail - {$row['email']}</h4>
                    <h4 class='h4-profile'>
                        Tel. - "
                        . substr($row['tel'], 0, 3) . "-"
                        . substr($row['tel'], 3, 4) . "-"

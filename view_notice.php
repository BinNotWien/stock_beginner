    ...
    <main class="main-container">
        ...
        <div class="article">
            <div class="article-md-8">
                ...
                echo "
                <div class='article-md-8-h-view'>
                    <h2 class='h2-view'>{$rows['title']}</h2>
                </div>
                
                <div class='btn-box-view'>
                    <a href='./nav_notice.php' class='btn-back btn-v1 btn-primary-2'>
                        <<<
                    </a>
                    <a href='./modify.php?id={$id}&where=notice' class='btn-modify-view btn-v1 btn-primary-submit'>
                        Modify
                    </a>
                    <a href='./PHP/delete_pc.php?id={$id}&where=notice' class='btn-delete-view btn-v1 btn-primary-reset'>
                        Delete
                    </a>
                </div>
                ...
                $sql = "update notice set views = views + 1 where id = {$id}";
                mysqli_query($db, $sql);
                ?>

    ...
    <main class="main-container">
        ...
        <div class="article">
            <div class="article-md-8">
                ...
                <div class="write-box">
                    <a href="write_archive.php" class="btn-write btn-v1 btn-primary-2">
                        Write
                    </a>
                </div>
                ...
                <table class="table-notice table-hover">
                    ...
                    $sql = "select * from archive where is_deleted = 0 order by id desc limit 0, 10";
                    ...
                    while ($rows = mysqli_fetch_array($result)) {
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href='view_archive.php?id={$rows['id']}&where=archive'>
                                        {$rows['title']}
                                    </a>";
                        if (!$rows['file'] == "") {
                            echo "

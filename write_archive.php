    ...
    <main class="main-container">
        ...
        <div class="article">
            <div class="article-md-8">
                ...
                <div>
                    <a class="btn-back btn-v1 btn-primary-2" href="./nav_notice.php">
                        List
                    </a>
                </div>
                <hr>
                ...
                <div class="form-box">
                    <form action="./PHP/archive_write_pc.php" method="POST" enctype="multipart/form-data">

                        <div class="form-group">
                            <div class="from-group-prepend" style="margin-right: 10px;">
                                제목
                            </div>
                            <input class="form-ctrl" type="text" name="title">
                        </div>
                        <hr>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-ctrl" name="content" cols="30" rows="10"></textarea>
                        </div>
                        <hr>
                        ...
                        <div class="submit-box">
                            ...
                            <input class="btn-submit btn-v1 btn-primary-submit" type="submit" value="Submit">
                        </div>
                    </form>
                </div>

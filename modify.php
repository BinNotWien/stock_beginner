...
include_once "./PHP/user_check.php";
?>
<html lang="ko">
    ...
    <main class="main-container">
        ...
        <div class="article">
            <div class="article-md-8">
                ...
                echo "
                <div>
                    <a class='btn-back btn-v1 btn-primary-2' href='./nav_{$loc}.php'>
                        List
                    </a>
                </div>
                <hr>";
                ...
                echo "
                <div class='form-box'>
                    <form action='./PHP/modify_pc.php?id={$id}&where={$loc}' method='POST' enctype='multipart/form-data'>";
                ...
                echo "
                        <div class='form-group'>
                            ...
                            <input class='form-ctrl' type='text' name='title' value='{$rows['title']}'>
                        </div>
                        <hr>
                        ...
                        <div class='form-group'>
                            ...
                            <textarea class='form-ctrl' name='content' cols='30' rows='10'>{$rows['content']}</textarea>
                        </div>
                        <hr>
                        ...
                        <div class='form-group'>
                            ...
                            <input class='form-ctrl-file' type='file' name='uploadfile'>
                        </div>
                        <hr>

                        <div class='submit-box'>
                            <input class='btn-reset btn-v1 btn-primary-reset' type='reset' value='Reset'>
                            <input class='btn-submit btn-v1 btn-primary-submit' type='submit' value='Modify'>
                        </div>"
